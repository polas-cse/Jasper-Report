...
@Component({
  selector: 'ast-pdf-viewer-by-url',
  templateUrl: './pdf-viewer-by-url.component.html',
})
export class PdfViewerByUrlComponent implements OnInit {
  public pdf: any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PdfViewerByUrlComponent>,
  ...
  setFilename(filename: string) {
    // suggested file name of downloaded file
    // this.fileName = 'demo_document';
  ...
  downloadPdf() {
    this.download(this.fileName, 'application/pdf', this.pdfBlob);
  }
